...
export default function RegistroRestaurante() {
  ...
  return (
    ...
    >
      <div className="relative flex justify-center  my-4 w-1/2">
        <div className="bg-[#242424] h-full p-8 rounded-lg shadow-lg w-[650px] max-w-5xl flex">
          ...
          <form
            ...
            className="w-1/2 mt-32 ml-10 space-y-6"
          >
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <div className="flex-1 relative">
                ...
                <div className="inline-flex items-center space-x-4 ml-20">
                  ...
                  />
                  <label htmlFor="aceptaSi" className="mr-4 text-white">
                    Sí
                  </label>
                  ...
                  />
                  <label htmlFor="aceptaNo" className="text-white">
                    No
                  </label>
                </div>
              </div>
            ...
            <div className="flex ml-[170px] mt-4">
              <button
                className="w-96 h-10 px-8 font-verdana cursor-pointer text-[#242424] rounded-lg bg-white bg-opacity-50 hover:bg-opacity-100"
